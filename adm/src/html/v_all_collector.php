  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title fw-semibold mb-4">View Milk Collector Details</h5>
    ...
    WHERE s.status = 1 and s.location_society=$loc_id
    "); 
                     $stmt->execute();
                     ...
                     if ($result->num_rows > 0) {
                      ...
                      while ($row = $result->fetch_assoc()) {
                          ...
                          echo '<td class="border-bottom-0"><form method="POST" action="../databases/reject_collector.php">';
                          ...
                          echo '</form></td>';
                          echo '<td class="border-bottom-0"><form method="POST" action="../databases/delete_collector.php">';
                          echo '<input type="hidden" name="user_id" value="' . $row['c_Id'] . '">'; // Assuming you have an ID column
